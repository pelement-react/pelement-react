...
const Rate: React.ForwardRefRenderFunction<HTMLDivElement, RateProps> = (
  ...
  return (
    <div
      ...
      role="slider"
    >
      <span className="el-rate__item">
        <i className="el-icon el-rate__icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" style={{ display: 'none' }}>
...
const RateComponent = forwardRef<HTMLDivElement, RateProps>(Rate)
