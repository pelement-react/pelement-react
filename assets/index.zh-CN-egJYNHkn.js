import{j as e}from"./index-ier0czJn.js";import{G as r,b as s}from"./index-n0SndFb9.js";function l(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"success alert",type:"success"}),e.jsx(r,{title:"info alert",type:"info"}),e.jsx(r,{title:"warning alert",type:"warning"}),e.jsx(r,{title:"error alert",type:"error"})]})}function i(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"success alert",type:"success",effect:"dark"}),e.jsx(r,{title:"info alert",type:"info",effect:"dark"}),e.jsx(r,{title:"warning alert",type:"warning",effect:"dark"}),e.jsx(r,{title:"error alert",type:"error",effect:"dark"})]})}function d(){function n(){alert("Hello World!")}return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"unclosable alert",type:"success",closable:!1}),e.jsx(r,{title:"customized close-text",type:"info",closeText:"Gotcha"}),e.jsx(r,{title:"alert with callback",type:"warning",close:n})]})}function h(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"success alert",type:"success",showIcon:!0}),e.jsx(r,{title:"info alert",type:"info",showIcon:!0}),e.jsx(r,{title:"warning alert",type:"warning",showIcon:!0}),e.jsx(r,{title:"error alert",type:"error",showIcon:!0})]})}function x(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"success alert",type:"success",center:!0,showIcon:!0}),e.jsx(r,{title:"info alert",type:"info",center:!0,showIcon:!0}),e.jsx(r,{title:"warning alert",type:"warning",center:!0,showIcon:!0}),e.jsx(r,{title:"error alert",type:"error",center:!0,showIcon:!0})]})}function o(){return e.jsx(e.Fragment,{children:e.jsx(r,{title:"with description",type:"success",description:"This is a description."})})}function j(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"success alert",type:"success",description:"more text description",showIcon:!0}),e.jsx(r,{title:"info alert",type:"info",description:"more text description",showIcon:!0}),e.jsx(r,{title:"warning alert",type:"warning",description:"more text description",showIcon:!0}),e.jsx(r,{title:"error alert",type:"error",description:"more text description",showIcon:!0})]})}function c(n){const t={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{children:"Alert 提示"}),`
`,`
...
`,e.jsx(s,{name:"AlertBasic",children:e.jsx(l,{})}),`
...
`,e.jsx(s,{name:"AlertEffect",children:e.jsx(i,{})}),`
...
`,e.jsx(s,{name:"AlertClose",children:e.jsx(d,{})}),`
...
`,e.jsx(s,{name:"AlertDescription",children:e.jsx(o,{})}),`
`,e.jsx(t.h2,{children:"带图标和描述"}),`
`,e.jsx(t.p,{children:"在最后, 这是一个带有图标和描述的例子。"}),`
`,e.jsx(s,{name:"AlertIconDescription",children:e.jsx(j,{})}),`
...
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{children:"名称"}),e.jsx(t.th,{children:"描述"}),e.jsx(t.th,{children:"类型"})]})}),e.jsx(t.tbody,{children:e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"close"}),e.jsx(t.td,{children:"关闭 Alert 时触发的事件"}),e.jsx(t.td,{children:"(event: MouseEvent) => void"})]})})]})]})}function u(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(c,{...n})}):c(n)}export{u as default};
