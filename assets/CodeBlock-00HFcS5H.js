import{g as ar,r as oe,j as k}from"./index-DC7_VHN2.js";const or=`import { Alert } from 'pelement-react'\r
...
\r
export default BadgeIsDot`,xr=`import { Badge, Button } from 'pelement-react'\r
\r
function BadgeMax() {\r
  return (\r
    <>\r
...
\r
export default BadgeMax`,br=`import { Badge, Button } from 'pelement-react'\r
\r
...
\r
export default BadgeValue`,Br=`import { Button, Check, Delete, Edit, Message, Search, Star } from 'pelement-react'\r
\r
...
\r
export default ButtonBasic`,vr=`import { Button } from 'pelement-react'\r
\r
...
\r
export default ButtonLink`,Cr=`import { Button } from 'pelement-react'\r
\r
...
\r
export default ButtonText`,wr=`import { Collapse, CollapseItem } from 'pelement-react'\r
\r
...
\r
export default ContainerBasic`,kr=`import { Container, Footer, Header, Main } from 'pelement-react'\r
\r
...
\r
export default ContainerBasic1`,Sr=`import { Aside, Container, Main } from 'pelement-react'\r
\r
...
\r
export default DialogBasic`,Mr=`import { useState } from 'react'\r
...
\r
export default DialogContent`,Lr=`import { useState } from 'react'\r
...
\r
export default DrawerHeader`,Wr=`import { useState } from 'react'\r
import { Button, Drawer } from 'pelement-react'\r
\r
...
\r
export default DrawerWithHeader`,jr=`import { Edit, Search, Check, Message, Star, Delete, View, StarFilled, Loading, Hide, InfoFilled, WarningFilled, CircleCloseFilled, CircleCheckFilled, ArrowRight, CircleCheck, Close, Share } from 'pelement-react'\r
\r
function ButtonBasic() {\r
  return (\r
    <>\r
...
\r
export default ButtonBasic`,Gr=`import { useState } from 'react'\r
...
\r
export default InputBasic`,$r=`import { useState } from 'react'\r
import { Input } from 'pelement-react'\r
\r
...
\r
export default InputClearable`,Vr=`import { useState } from 'react'\r
import { Input } from 'pelement-react'\r
\r
...
\r
export default InputDisabled`,Kr=`import { useState } from 'react'\r
import { Input } from 'pelement-react'\r
...
\r
export default InputSize`,Zr=`import { Col, Row } from 'pelement-react'\r
...
\r
export default LayoutBasic`,Xr=`import { Col, Row } from 'pelement-react'\r
\r
...
\r
export default LayoutGutter`,Yr=`import { Col, Row } from 'pelement-react'\r
\r
...
\r
export default LayoutJustify`,Jr=`import { Col, Row } from 'pelement-react'\r
\r
...
\r
export default LayoutMix`,Qr=`import { Col, Row } from 'pelement-react'\r
\r
...
\r
export default LayoutOffset`,et=`import { Link } from 'pelement-react'\r
...
\r
export default LinkBasic`,rt=`import { Link } from 'pelement-react'\r
\r
...
\r
export default LinkDisabled`,tt=`import { Edit, Link, View } from 'pelement-react'\r
\r
function LinkIcon() {\r
  return (\r
    <>\r
...
\r
export default LinkIcon`,nt=`import { Link } from 'pelement-react'\r
\r
...
\r
export default LinkUnderline`,at=`import { Button, message } from 'pelement-react'\r
\r
...
\r
export default MessageBasic`,ot=`import { Button, message } from 'pelement-react'\r
\r
...
\r
export default MessageCenter`,it=`import { Button, message } from 'pelement-react'\r
\r
...
\r
export default MessagePlain`,st=`import { Button, message } from 'pelement-react'\r
\r
...
\r
export default MessageShowClose`,lt=`import { Button, message } from 'pelement-react'\r
\r
...
\r
export default MessageType`,ct=`import { Button, messageBox } from 'pelement-react'\r
\r
...
\r
export default MessageBoxBasic`,pt=`import { Button, messageBox } from 'pelement-react'\r
\r
...
\r
export default MessageBoxConfirm`,ut=`import { Button, messageBox, Switch } from 'pelement-react'\r
\r
...
\r
export default MessageBoxMessage`,dt=`import { Button, notification } from 'pelement-react'\r
\r
...
\r
export default NotificationBasic`,gt=`import { Button, notification } from 'pelement-react'\r
\r
...
\r
export default NotificationType`,mt=`import { Button, notification } from 'pelement-react'\r
\r
...
\r
export default NotificationShowClose`,ft=`import { Button, notification } from 'pelement-react'\r
\r
function NotificationType() {\r
  function open1() {\r
    notification.open({\r
...
\r
export default NotificationType`,ht=`import { Button, Popconfirm } from 'pelement-react'\r
\r
...
\r
export default PopconfirmBasic`,_t=`import { Button, InfoFilled, Popconfirm } from 'pelement-react'\r
\r
...
\r
export default PopconfirmEvent`,xt=`import { Button, InfoFilled, Popconfirm } from 'pelement-react'\r
\r
...
\r
export default PopconfirmIcon`,bt=`import { Button, Popover } from 'pelement-react'\r
\r
...
\r
export default PopoverBasic`,Bt=`import { Progress } from 'pelement-react'\r
...
\r
export default ProgressBasic`,vt=`import { Progress } from 'pelement-react'\r
\r
...
\r
export default ProgressTextInside`,yt=`import { Rate } from 'pelement-react'\r
\r
...
\r
export default RateBasic`,Ct=`import { Button, Col, Result, Row } from 'pelement-react'\r
\r
...
\r
export default ResultBasic`,wt=`import { Button, Result } from 'pelement-react'\r
\r
...
\r
export default ResultIcon`,Tt=`import { Scrollbar } from 'pelement-react'\r
...
\r
export default ScrollbarBasic`,kt=`import { Button, Space } from 'pelement-react'\r
\r
...
\r
export default SpaceAlignment`,St=`import { Space } from 'pelement-react'\r
\r
...
\r
export default SpaceBasic`,Nt=`import { Space } from 'pelement-react'\r
\r
...
\r
export default SpaceDirection`,Et=`import { Space } from 'pelement-react'\r
\r
...
\r
export default SpaceSize`,At=`import { Space } from 'pelement-react'\r
\r
...
\r
export default SpaceSize2`,Dt=`import { Button, Space } from 'pelement-react'\r
\r
...
\r
export default SpaceSpacer`,Rt=`import { Button, Divider, Space } from 'pelement-react'\r
\r
...
\r
export default SpaceSpacer2`,Mt=`import { Button, Space } from 'pelement-react'\r
\r
...
\r
export default SpaceWrap`,Lt=`import { Hide, Switch, View } from 'pelement-react'\r
\r
...
\r
export default SwitchActionIcon`,It=`import { Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchBasic`,Ot=`import { useState } from 'react'\r
...
\r
export default SwitchBeforeChange`,Pt=`import { Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchDisabled`,zt=`import { Check, Close, Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchIcon`,Ft=`import { Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchLoading`,Ht=`import { Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchSize`,Ut=`import { Switch } from 'pelement-react'\r
\r
...
\r
export default SwitchText`,Wt=`import { Table } from 'pelement-react'\r
\r
...
\r
export default TableBasic`,jt=`import { Table } from 'pelement-react'\r
\r
...
\r
export default TableBorder`,Gt=`import { Table } from 'pelement-react'\r
\r
...
\r
export default TableStripe`,$t=`import { Tag } from 'pelement-react'\r
\r
function TagBasic() {\r
  return (\r
    <>\r
...
\r
export default TagBasic`,Vt=`import { Tag } from 'pelement-react'\r
\r
...
\r
export default TagClosable`,Kt=`import { Tag } from 'pelement-react'\r
\r
...
\r
export default TagEffect`,Zt=`import { Tag } from 'pelement-react'\r
\r
function TagRound() {\r
  const items = [\r
    { type: '', label: 'Tag 1' },\r
...
\r
export default TagRound`,Xt=`import { Row, Tag } from 'pelement-react'\r
\r
function TagSize() {\r
  return (\r
    <>\r
...
\r
export default TextBasic`,Yt=`import { Text } from 'pelement-react'\r
\r
function TextSize() {\r
  return (\r
    <>\r
...
\r
export default TextSize`,Jt=`import { Row, Text } from 'pelement-react'\r
\r
...
\r
export default TextTruncated`,Qt=`import { Button, Tooltip } from 'pelement-react'\r
...
\r
export default TooltipBasic`,en=`import { Button, Tooltip } from 'pelement-react'\r
\r
...
\r
export default TooltipContent`,rn=`import { useState } from 'react'\r
...
\r
export default TooltipDisabled`,tn=`import { Button, Tooltip } from 'pelement-react'\r
\r
...
\r
export default TooltipEffect`;function Oe(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(r=>{const n=e[r],s=typeof n;(s==="object"||s==="function")&&!Object.isFrozen(n)&&Oe(n)}),e}class Ne{constructor(r){r.data===void 0&&(r.data={}),this.data=r.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function Pe(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function L(e,...r){const n=Object.create(null);for(const s in e)n[s]=e[s];return r.forEach(function(s){for(const f in s)n[f]=s[f]}),n}const nn="</span>",Ee=e=>!!e.scope,an=(e,{prefix:r})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){const n=e.split(".");return[`${r}${n.shift()}`,...n.map((s,f)=>`${s}${"_".repeat(f+1)}`)].join(" ")}return`${r}${e}`};class on{constructor(r,n){this.buffer="",this.classPrefix=n.classPrefix,r.walk(this)}addText(r){this.buffer+=Pe(r)}openNode(r){if(!Ee(r))return;const n=an(r.scope,{prefix:this.classPrefix});this.span(n)}closeNode(r){Ee(r)&&(this.buffer+=nn)}value(){return this.buffer}span(r){this.buffer+=`<span class="${r}">`}}const Ae=(e={})=>{const r={children:[]};return Object.assign(r,e),r};class _e{constructor(){this.rootNode=Ae(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(r){this.top.children.push(r)}openNode(r){const n=Ae({scope:r});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(r){return this.constructor._walk(r,this.rootNode)}static _walk(r,n){return typeof n=="string"?r.addText(n):n.children&&(r.openNode(n),n.children.forEach(s=>this._walk(r,s)),r.closeNode(n)),r}static _collapse(r){typeof r!="string"&&r.children&&(r.children.every(n=>typeof n=="string")?r.children=[r.children.join("")]:r.children.forEach(n=>{_e._collapse(n)}))}}class sn extends _e{constructor(r){super(),this.options=r}addText(r){r!==""&&this.add(r)}startScope(r){this.openNode(r)}endScope(){this.closeNode()}__addSublanguage(r,n){const s=r.root;n&&(s.scope=`language:${n}`),this.add(s)}toHTML(){return new on(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function Z(e){return e?typeof e=="string"?e:e.source:null}function ze(e){return F("(?=",e,")")}function ln(e){return F("(?:",e,")*")}function cn(e){return F("(?:",e,")?")}function F(...e){return e.map(n=>Z(n)).join("")}function pn(e){const r=e[e.length-1];return typeof r=="object"&&r.constructor===Object?(e.splice(e.length-1,1),r):{}}function xe(...e){return"("+(pn(e).capture?"":"?:")+e.map(s=>Z(s)).join("|")+")"}function Fe(e){return new RegExp(e.toString()+"|").exec("").length-1}function un(e,r){const n=e&&e.exec(r);return n&&n.index===0}const dn=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function be(e,{joinWith:r}){let n=0;return e.map(s=>{n+=1;const f=n;let h=Z(s),i="";for(;h.length>0;){const a=dn.exec(h);if(!a){i+=h;break}i+=h.substring(0,a.index),h=h.substring(a.index+a[0].length),a[0][0]==="\\"&&a[1]?i+="\\"+String(Number(a[1])+f):(i+=a[0],a[0]==="("&&n++)}return i}).map(s=>`(${s})`).join(r)}const gn=/\b\B/,He="[a-zA-Z]\\w*",Be="[a-zA-Z_]\\w*",Ue="\\b\\d+(\\.\\d+)?",We="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",je="\\b(0b[01]+)",mn="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",fn=(e={})=>{const r=/^#![ ]*\//;return e.binary&&(e.begin=F(r,/.*\b/,e.binary,/\b.*/)),L({scope:"meta",begin:r,end:/$/,relevance:0,"on:begin":(n,s)=>{n.index!==0&&s.ignoreMatch()}},e)},X={begin:"\\\\[\\s\\S]",relevance:0},hn={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[X]},_n={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[X]},xn={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},le=function(e,r,n={}){const s=L({scope:"comment",begin:e,end:r,contains:[]},n);s.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const f=xe("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return s.contains.push({begin:F(/[ ]+/,"(",f,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),s},bn=le("//","$"),Bn=le("/\\*","\\*/"),vn=le("#","$"),yn={scope:"number",begin:Ue,relevance:0},Cn={scope:"number",begin:We,relevance:0},wn={scope:"number",begin:je,relevance:0},Tn={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[X,{begin:/\[/,end:/\]/,relevance:0,contains:[X]}]},kn={scope:"title",begin:He,relevance:0},Sn={scope:"title",begin:Be,relevance:0},Nn={begin:"\\.\\s*"+Be,relevance:0},En=function(e){return Object.assign(e,{"on:begin":(r,n)=>{n.data._beginMatch=r[1]},"on:end":(r,n)=>{n.data._beginMatch!==r[1]&&n.ignoreMatch()}})};var ie=Object.freeze({__proto__:null,APOS_STRING_MODE:hn,BACKSLASH_ESCAPE:X,BINARY_NUMBER_MODE:wn,BINARY_NUMBER_RE:je,COMMENT:le,C_BLOCK_COMMENT_MODE:Bn,C_LINE_COMMENT_MODE:bn,C_NUMBER_MODE:Cn,C_NUMBER_RE:We,END_SAME_AS_BEGIN:En,HASH_COMMENT_MODE:vn,IDENT_RE:He,MATCH_NOTHING_RE:gn,METHOD_GUARD:Nn,NUMBER_MODE:yn,NUMBER_RE:Ue,PHRASAL_WORDS_MODE:xn,QUOTE_STRING_MODE:_n,REGEXP_MODE:Tn,RE_STARTERS_RE:mn,SHEBANG:fn,TITLE_MODE:kn,UNDERSCORE_IDENT_RE:Be,UNDERSCORE_TITLE_MODE:Sn});function An(e,r){e.input[e.index-1]==="."&&r.ignoreMatch()}function Dn(e,r){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Rn(e,r){r&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=An,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function Mn(e,r){Array.isArray(e.illegal)&&(e.illegal=xe(...e.illegal))}function Ln(e,r){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function In(e,r){e.relevance===void 0&&(e.relevance=1)}const On=(e,r)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");const n=Object.assign({},e);Object.keys(e).forEach(s=>{delete e[s]}),e.keywords=n.keywords,e.begin=F(n.beforeMatch,ze(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},Pn=["of","and","for","in","not","or","if","then","parent","list","value"],zn="keyword";function Ge(e,r,n=zn){const s=Object.create(null);return typeof e=="string"?f(n,e.split(" ")):Array.isArray(e)?f(n,e):Object.keys(e).forEach(function(h){Object.assign(s,Ge(e[h],r,h))}),s;function f(h,i){r&&(i=i.map(a=>a.toLowerCase())),i.forEach(function(a){const p=a.split("|");s[p[0]]=[h,Fn(p[0],p[1])]})}}function Fn(e,r){return r?Number(r):Hn(e)?0:1}function Hn(e){return Pn.includes(e.toLowerCase())}const De={},z=e=>{console.error(e)},Re=(e,...r)=>{console.log(`WARN: ${e}`,...r)},j=(e,r)=>{De[`${e}/${r}`]||(console.log(`Deprecated as of ${e}. ${r}`),De[`${e}/${r}`]=!0)},se=new Error;function $e(e,r,{key:n}){let s=0;const f=e[n],h={},i={};for(let a=1;a<=r.length;a++)i[a+s]=f[a],h[a+s]=!0,s+=Fe(r[a-1]);e[n]=i,e[n]._emit=h,e[n]._multi=!0}function Un(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw z("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),se;if(typeof e.beginScope!="object"||e.beginScope===null)throw z("beginScope must be object"),se;$e(e,e.begin,{key:"beginScope"}),e.begin=be(e.begin,{joinWith:""})}}function Wn(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw z("skip, excludeEnd, returnEnd not compatible with endScope: {}"),se;if(typeof e.endScope!="object"||e.endScope===null)throw z("endScope must be object"),se;$e(e,e.end,{key:"endScope"}),e.end=be(e.end,{joinWith:""})}}function jn(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Gn(e){jn(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Un(e),Wn(e)}function $n(e){function r(i,a){return new RegExp(Z(i),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(a?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(a,p){p.position=this.position++,this.matchIndexes[this.matchAt]=p,this.regexes.push([p,a]),this.matchAt+=Fe(a)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const a=this.regexes.map(p=>p[1]);this.matcherRe=r(be(a,{joinWith:"|"}),!0),this.lastIndex=0}exec(a){this.matcherRe.lastIndex=this.lastIndex;const p=this.matcherRe.exec(a);if(!p)return null;const _=p.findIndex((S,E)=>E>0&&S!==void 0),b=this.matchIndexes[_];return p.splice(0,_),Object.assign(p,b)}}class s{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(a){if(this.multiRegexes[a])return this.multiRegexes[a];const p=new n;return this.rules.slice(a).forEach(([_,b])=>p.addRule(_,b)),p.compile(),this.multiRegexes[a]=p,p}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(a,p){this.rules.push([a,p]),p.type==="begin"&&this.count++}exec(a){const p=this.getMatcher(this.regexIndex);p.lastIndex=this.lastIndex;let _=p.exec(a);if(this.resumingScanAtSamePosition()&&!(_&&_.index===this.lastIndex)){const b=this.getMatcher(0);b.lastIndex=this.lastIndex+1,_=b.exec(a)}return _&&(this.regexIndex+=_.position+1,this.regexIndex===this.count&&this.considerAll()),_}}function f(i){const a=new s;return i.contains.forEach(p=>a.addRule(p.begin,{rule:p,type:"begin"})),i.terminatorEnd&&a.addRule(i.terminatorEnd,{type:"end"}),i.illegal&&a.addRule(i.illegal,{type:"illegal"}),a}function h(i,a){const p=i;if(i.isCompiled)return p;[Dn,Ln,Gn,On].forEach(b=>b(i,a)),e.compilerExtensions.forEach(b=>b(i,a)),i.__beforeBegin=null,[Rn,Mn,In].forEach(b=>b(i,a)),i.isCompiled=!0;let _=null;return typeof i.keywords=="object"&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),_=i.keywords.$pattern,delete i.keywords.$pattern),_=_||/\w+/,i.keywords&&(i.keywords=Ge(i.keywords,e.case_insensitive)),p.keywordPatternRe=r(_,!0),a&&(i.begin||(i.begin=/\B|\b/),p.beginRe=r(p.begin),!i.end&&!i.endsWithParent&&(i.end=/\B|\b/),i.end&&(p.endRe=r(p.end)),p.terminatorEnd=Z(p.end)||"",i.endsWithParent&&a.terminatorEnd&&(p.terminatorEnd+=(i.end?"|":"")+a.terminatorEnd)),i.illegal&&(p.illegalRe=r(i.illegal)),i.contains||(i.contains=[]),i.contains=[].concat(...i.contains.map(function(b){return Vn(b==="self"?i:b)})),i.contains.forEach(function(b){h(b,p)}),i.starts&&h(i.starts,a),p.matcher=f(p),p}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=L(e.classNameAliases||{}),h(e)}function Ve(e){return e?e.endsWithParent||Ve(e.starts):!1}function Vn(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(r){return L(e,{variants:null},r)})),e.cachedVariants?e.cachedVariants:Ve(e)?L(e,{starts:e.starts?L(e.starts):null}):Object.isFrozen(e)?L(e):e}var Kn="11.9.0";class Zn extends Error{constructor(r,n){super(r),this.name="HTMLInjectionError",this.html=n}}const he=Pe,Me=L,Le=Symbol("nomatch"),Xn=7,Ke=function(e){const r=Object.create(null),n=Object.create(null),s=[];let f=!0;const h="Could not find the language '{}', did you forget to load/include a language module?",i={disableAutodetect:!0,name:"Plain text",contains:[]};let a={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:sn};function p(t){return a.noHighlightRe.test(t)}function _(t){let l=t.className+" ";l+=t.parentNode?t.parentNode.className:"";const d=a.languageDetectRe.exec(l);if(d){const m=A(d[1]);return m||(Re(h.replace("{}",d[1])),Re("Falling back to no-highlight mode for this block.",t)),m?d[1]:"no-highlight"}return l.split(/\s+/).find(m=>p(m)||A(m))}function b(t,l,d){let m="",v="";typeof l=="object"?(m=t,d=l.ignoreIllegals,v=l.language):(j("10.7.0","highlight(lang, code, ...args) has been deprecated."),j("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),v=t,m=l),d===void 0&&(d=!0);const w={code:m,language:v};W("before:highlight",w);const N=w.result?w.result:S(w.language,w.code,d);return N.code=w.code,W("after:highlight",N),N}function S(t,l,d,m){const v=Object.create(null);function w(o,c){return o.keywords[c]}function N(){if(!u.keywords){y.addText(B);return}let o=0;u.keywordPatternRe.lastIndex=0;let c=u.keywordPatternRe.exec(B),g="";for(;c;){g+=B.substring(o,c.index);const x=R.case_insensitive?c[0].toLowerCase():c[0],C=w(u,x);if(C){const[M,tr]=C;if(y.addText(g),g="",v[x]=(v[x]||0)+1,v[x]<=Xn&&(ae+=tr),M.startsWith("_"))g+=c[0];else{const nr=R.classNameAliases[M]||M;D(c[0],nr)}}else g+=c[0];o=u.keywordPatternRe.lastIndex,c=u.keywordPatternRe.exec(B)}g+=B.substring(o),y.addText(g)}function te(){if(B==="")return;let o=null;if(typeof u.subLanguage=="string"){if(!r[u.subLanguage]){y.addText(B);return}o=S(u.subLanguage,B,!0,Se[u.subLanguage]),Se[u.subLanguage]=o._top}else o=H(B,u.subLanguage.length?u.subLanguage:null);u.relevance>0&&(ae+=o.relevance),y.__addSublanguage(o._emitter,o.language)}function T(){u.subLanguage!=null?te():N(),B=""}function D(o,c){o!==""&&(y.startScope(c),y.addText(o),y.endScope())}function Ce(o,c){let g=1;const x=c.length-1;for(;g<=x;){if(!o._emit[g]){g++;continue}const C=R.classNameAliases[o[g]]||o[g],M=c[g];C?D(M,C):(B=M,N(),B=""),g++}}function we(o,c){return o.scope&&typeof o.scope=="string"&&y.openNode(R.classNameAliases[o.scope]||o.scope),o.beginScope&&(o.beginScope._wrap?(D(B,R.classNameAliases[o.beginScope._wrap]||o.beginScope._wrap),B=""):o.beginScope._multi&&(Ce(o.beginScope,c),B="")),u=Object.create(o,{parent:{value:u}}),u}function Te(o,c,g){let x=un(o.endRe,g);if(x){if(o["on:end"]){const C=new Ne(o);o["on:end"](c,C),C.isMatchIgnored&&(x=!1)}if(x){for(;o.endsParent&&o.parent;)o=o.parent;return o}}if(o.endsWithParent)return Te(o.parent,c,g)}function Ye(o){return u.matcher.regexIndex===0?(B+=o[0],1):(fe=!0,0)}function Je(o){const c=o[0],g=o.rule,x=new Ne(g),C=[g.__beforeBegin,g["on:begin"]];for(const M of C)if(M&&(M(o,x),x.isMatchIgnored))return Ye(c);return g.skip?B+=c:(g.excludeBegin&&(B+=c),T(),!g.returnBegin&&!g.excludeBegin&&(B=c)),we(g,o),g.returnBegin?0:c.length}function Qe(o){const c=o[0],g=l.substring(o.index),x=Te(u,o,g);if(!x)return Le;const C=u;u.endScope&&u.endScope._wrap?(T(),D(c,u.endScope._wrap)):u.endScope&&u.endScope._multi?(T(),Ce(u.endScope,o)):C.skip?B+=c:(C.returnEnd||C.excludeEnd||(B+=c),T(),C.excludeEnd&&(B=c));do u.scope&&y.closeNode(),!u.skip&&!u.subLanguage&&(ae+=u.relevance),u=u.parent;while(u!==x.parent);return x.starts&&we(x.starts,o),C.returnEnd?0:c.length}function er(){const o=[];for(let c=u;c!==R;c=c.parent)c.scope&&o.unshift(c.scope);o.forEach(c=>y.openNode(c))}let ne={};function ke(o,c){const g=c&&c[0];if(B+=o,g==null)return T(),0;if(ne.type==="begin"&&c.type==="end"&&ne.index===c.index&&g===""){if(B+=l.slice(c.index,c.index+1),!f){const x=new Error(`0 width match regex (${t})`);throw x.languageName=t,x.badRule=ne.rule,x}return 1}if(ne=c,c.type==="begin")return Je(c);if(c.type==="illegal"&&!d){const x=new Error('Illegal lexeme "'+g+'" for mode "'+(u.scope||"<unnamed>")+'"');throw x.mode=u,x}else if(c.type==="end"){const x=Qe(c);if(x!==Le)return x}if(c.type==="illegal"&&g==="")return 1;if(me>1e5&&me>c.index*3)throw new Error("potential infinite loop, way more iterations than matches");return B+=g,g.length}const R=A(t);if(!R)throw z(h.replace("{}",t)),new Error('Unknown language: "'+t+'"');const rr=$n(R);let ge="",u=m||rr;const Se={},y=new a.__emitter(a);er();let B="",ae=0,P=0,me=0,fe=!1;try{if(R.__emitTokens)R.__emitTokens(l,y);else{for(u.matcher.considerAll();;){me++,fe?fe=!1:u.matcher.considerAll(),u.matcher.lastIndex=P;const o=u.matcher.exec(l);if(!o)break;const c=l.substring(P,o.index),g=ke(c,o);P=o.index+g}ke(l.substring(P))}return y.finalize(),ge=y.toHTML(),{language:t,value:ge,relevance:ae,illegal:!1,_emitter:y,_top:u}}catch(o){if(o.message&&o.message.includes("Illegal"))return{language:t,value:he(l),illegal:!0,relevance:0,_illegalBy:{message:o.message,index:P,context:l.slice(P-100,P+100),mode:o.mode,resultSoFar:ge},_emitter:y};if(f)return{language:t,value:he(l),illegal:!1,relevance:0,errorRaised:o,_emitter:y,_top:u};throw o}}function E(t){const l={value:he(t),illegal:!1,relevance:0,_top:i,_emitter:new a.__emitter(a)};return l._emitter.addText(t),l}function H(t,l){l=l||a.languages||Object.keys(r);const d=E(t),m=l.filter(A).filter(ee).map(T=>S(T,t,!1));m.unshift(d);const v=m.sort((T,D)=>{if(T.relevance!==D.relevance)return D.relevance-T.relevance;if(T.language&&D.language){if(A(T.language).supersetOf===D.language)return 1;if(A(D.language).supersetOf===T.language)return-1}return 0}),[w,N]=v,te=w;return te.secondBest=N,te}function q(t,l,d){const m=l&&n[l]||d;t.classList.add("hljs"),t.classList.add(`language-${m}`)}function U(t){let l=null;const d=_(t);if(p(d))return;if(W("before:highlightElement",{el:t,language:d}),t.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",t);return}if(t.children.length>0&&(a.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(t)),a.throwUnescapedHTML))throw new Zn("One of your code blocks includes unescaped HTML.",t.innerHTML);l=t;const m=l.textContent,v=d?b(m,{language:d,ignoreIllegals:!0}):H(m);t.innerHTML=v.value,t.dataset.highlighted="yes",q(t,d,v.language),t.result={language:v.language,re:v.relevance,relevance:v.relevance},v.secondBest&&(t.secondBest={language:v.secondBest.language,relevance:v.secondBest.relevance}),W("after:highlightElement",{el:t,result:v,text:m})}function Y(t){a=Me(a,t)}const ye=()=>{I(),j("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function $(){I(),j("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let V=!1;function I(){if(document.readyState==="loading"){V=!0;return}document.querySelectorAll(a.cssSelector).forEach(U)}function K(){V&&I()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",K,!1);function O(t,l){let d=null;try{d=l(e)}catch(m){if(z("Language definition for '{}' could not be registered.".replace("{}",t)),f)z(m);else throw m;d=i}d.name||(d.name=t),r[t]=d,d.rawDefinition=l.bind(null,e),d.aliases&&Q(d.aliases,{languageName:t})}function ce(t){delete r[t];for(const l of Object.keys(n))n[l]===t&&delete n[l]}function J(){return Object.keys(r)}function A(t){return t=(t||"").toLowerCase(),r[t]||r[n[t]]}function Q(t,{languageName:l}){typeof t=="string"&&(t=[t]),t.forEach(d=>{n[d.toLowerCase()]=l})}function ee(t){const l=A(t);return l&&!l.disableAutodetect}function pe(t){t["before:highlightBlock"]&&!t["before:highlightElement"]&&(t["before:highlightElement"]=l=>{t["before:highlightBlock"](Object.assign({block:l.el},l))}),t["after:highlightBlock"]&&!t["after:highlightElement"]&&(t["after:highlightElement"]=l=>{t["after:highlightBlock"](Object.assign({block:l.el},l))})}function ue(t){pe(t),s.push(t)}function de(t){const l=s.indexOf(t);l!==-1&&s.splice(l,1)}function W(t,l){const d=t;s.forEach(function(m){m[d]&&m[d](l)})}function re(t){return j("10.7.0","highlightBlock will be removed entirely in v12.0"),j("10.7.0","Please use highlightElement now."),U(t)}Object.assign(e,{highlight:b,highlightAuto:H,highlightAll:I,highlightElement:U,highlightBlock:re,configure:Y,initHighlighting:ye,initHighlightingOnLoad:$,registerLanguage:O,unregisterLanguage:ce,listLanguages:J,getLanguage:A,registerAliases:Q,autoDetection:ee,inherit:Me,addPlugin:ue,removePlugin:de}),e.debugMode=function(){f=!1},e.safeMode=function(){f=!0},e.versionString=Kn,e.regex={concat:F,lookahead:ze,either:xe,optional:cn,anyNumberOfTimes:ln};for(const t in ie)typeof ie[t]=="object"&&Oe(ie[t]);return Object.assign(e,ie),e},G=Ke({});G.newInstance=()=>Ke({});var qn=G;G.HighlightJS=G;G.default=G;const ve=ar(qn);function Yn(e){const r=e.regex,n=r.concat(/[\p{L}_]/u,r.optional(/[\p{L}0-9_.-]*:/u),/[\p{L}0-9_.-]*/u),s=/[\p{L}0-9._:-]+/u,f={className:"symbol",begin:/&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/},h={begin:/\s/,contains:[{className:"keyword",begin:/#?[a-z_][a-z1-9_-]+/,illegal:/\n/}]},i=e.inherit(h,{begin:/\(/,end:/\)/}),a=e.inherit(e.APOS_STRING_MODE,{className:"string"}),p=e.inherit(e.QUOTE_STRING_MODE,{className:"string"}),_={endsWithParent:!0,illegal:/</,relevance:0,contains:[{className:"attr",begin:s,relevance:0},{begin:/=\s*/,relevance:0,contains:[{className:"string",endsParent:!0,variants:[{begin:/"/,end:/"/,contains:[f]},{begin:/'/,end:/'/,contains:[f]},{begin:/[^\s"'=<>`]+/}]}]}]};return{name:"HTML, XML",aliases:["html","xhtml","rss","atom","xjb","xsd","xsl","plist","wsf","svg"],case_insensitive:!0,unicodeRegex:!0,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,relevance:10,contains:[h,p,a,i,{begin:/\[/,end:/\]/,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,contains:[h,i,p,a]}]}]},e.COMMENT(/<!--/,/-->/,{relevance:10}),{begin:/<!\[CDATA\[/,end:/\]\]>/,relevance:10},f,{className:"meta",end:/\?>/,variants:[{begin:/<\?xml/,relevance:10,contains:[p]},{begin:/<\?[a-z][a-z0-9]+/}]},{className:"tag",begin:/<style(?=\s|>)/,end:/>/,keywords:{name:"style"},contains:[_],starts:{end:/<\/style>/,returnEnd:!0,subLanguage:["css","xml"]}},{className:"tag",begin:/<script(?=\s|>)/,end:/>/,keywords:{name:"script"},contains:[_],starts:{end:/<\/script>/,returnEnd:!0,subLanguage:["javascript","handlebars","xml"]}},{className:"tag",begin:/<>|<\/>/},{className:"tag",begin:r.concat(/</,r.lookahead(r.concat(n,r.either(/\/>/,/>/,/\s/)))),end:/\/?>/,contains:[{className:"name",begin:n,relevance:0,starts:_}]},{className:"tag",begin:r.concat(/<\//,r.lookahead(r.concat(n,/>/))),contains:[{className:"name",begin:n,relevance:0},{begin:/>/,relevance:0,endsParent:!0}]}]}}const Ie="[A-Za-z$_][0-9A-Za-z$_]*",Jn=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],Qn=["true","false","null","undefined","NaN","Infinity"],Ze=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Xe=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],qe=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],ea=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ra=[].concat(qe,Ze,Xe);function ta(e){const r=e.regex,n=(l,{after:d})=>{const m="</"+l[0].slice(1);return l.input.indexOf(m,d)!==-1},s=Ie,f={begin:"<>",end:"</>"},h=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(l,d)=>{const m=l[0].length+l.index,v=l.input[m];if(v==="<"||v===","){d.ignoreMatch();return}v===">"&&(n(l,{after:m})||d.ignoreMatch());let w;const N=l.input.substring(m);if(w=N.match(/^\s*=/)){d.ignoreMatch();return}if((w=N.match(/^\s+extends\s+/))&&w.index===0){d.ignoreMatch();return}}},a={$pattern:Ie,keyword:Jn,literal:Qn,built_in:ra,"variable.language":ea},p="[0-9](_?[0-9])*",_=`\\.(${p})`,b="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",S={className:"number",variants:[{begin:`(\\b(${b})((${_})|\\.)?|(${_}))[eE][+-]?(${p})\\b`},{begin:`\\b(${b})\\b((${_})\\b|\\.)?|(${_})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},E={className:"subst",begin:"\\$\\{",end:"\\}",keywords:a,contains:[]},H={begin:"html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,E],subLanguage:"xml"}},q={begin:"css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,E],subLanguage:"css"}},U={begin:"gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,E],subLanguage:"graphql"}},Y={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,E]},$={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:s+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},V=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,H,q,U,Y,{match:/\$\d+/},S];E.contains=V.concat({begin:/\{/,end:/\}/,keywords:a,contains:["self"].concat(V)});const I=[].concat($,E.contains),K=I.concat([{begin:/\(/,end:/\)/,keywords:a,contains:["self"].concat(I)}]),O={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:a,contains:K},ce={variants:[{match:[/class/,/\s+/,s,/\s+/,/extends/,/\s+/,r.concat(s,"(",r.concat(/\./,s),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,s],scope:{1:"keyword",3:"title.class"}}]},J={relevance:0,match:r.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Ze,...Xe]}},A={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},Q={variants:[{match:[/function/,/\s+/,s,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[O],illegal:/%/},ee={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function pe(l){return r.concat("(?!",l.join("|"),")")}const ue={match:r.concat(/\b/,pe([...qe,"super","import"]),s,r.lookahead(/\(/)),className:"title.function",relevance:0},de={begin:r.concat(/\./,r.lookahead(r.concat(s,/(?![0-9A-Za-z$_(])/))),end:s,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},W={match:[/get|set/,/\s+/,s,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},O]},re="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",t={match:[/const|var|let/,/\s+/,s,/\s*/,/=\s*/,/(async\s*)?/,r.lookahead(re)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[O]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:a,exports:{PARAMS_CONTAINS:K,CLASS_REFERENCE:J},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),A,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,H,q,U,Y,$,{match:/\$\d+/},S,J,{className:"attr",begin:s+r.lookahead(":"),relevance:0},t,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[$,e.REGEXP_MODE,{className:"function",begin:re,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:a,contains:K}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:f.begin,end:f.end},{match:h},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},Q,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[O,e.inherit(e.TITLE_MODE,{begin:s,className:"title.function"})]},{match:/\.\.\./,relevance:0},de,{match:"\\$"+s,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[O]},ue,ee,ce,W,{match:/\$[(.]/}]}}ve.registerLanguage("xml",Yn);ve.registerLanguage("javascript",ta);function aa({language:e="javascript",name:r,children:n}){const s=oe.useRef(null),[f,h]=oe.useState(!1),[i,a]=oe.useState(""),p=Object.assign({"../../../packages/Alert/_example/AlertBasic.tsx":or,"../../../packages/Alert/_example/AlertCenter.tsx":ir,"../../../packages/Alert/_example/AlertClose.tsx":sr,"../../../packages/Alert/_example/AlertDescription.tsx":lr,"../../../packages/Alert/_example/AlertEffect.tsx":cr,"../../../packages/Alert/_example/AlertIconDescription.tsx":pr,"../../../packages/Alert/_example/AlertShowIcon.tsx":ur,"../../../packages/Avatar/_example/AvatarBasic.tsx":dr,"../../../packages/Avatar/_example/AvatarError.tsx":gr,"../../../packages/Avatar/_example/AvatarFit.tsx":mr,"../../../packages/Avatar/_example/AvatarType.tsx":fr,"../../../packages/Badge/_example/BadgeBasic.tsx":hr,"../../../packages/Badge/_example/BadgeIsDot.tsx":_r,"../../../packages/Badge/_example/BadgeMax.tsx":xr,"../../../packages/Badge/_example/BadgeValue.tsx":br,"../../../packages/Button/_example/ButtonBasic.tsx":Br,"../../../packages/Button/_example/ButtonDisabled.tsx":vr,"../../../packages/Button/_example/ButtonLink.tsx":yr,"../../../packages/Button/_example/ButtonText.tsx":Cr,"../../../packages/Collapse/_example/CollapseBasic.tsx":wr,"../../../packages/Container/_example/ContainerBasic.tsx":Tr,"../../../packages/Container/_example/ContainerBasic1.tsx":kr,"../../../packages/Container/_example/ContainerBasic2.tsx":Sr,"../../../packages/Container/_example/ContainerBasic3.tsx":Nr,"../../../packages/Container/_example/ContainerBasic4.tsx":Er,"../../../packages/Container/_example/ContainerBasic5.tsx":Ar,"../../../packages/Container/_example/ContainerBasic6.tsx":Dr,"../../../packages/Dialog/_example/DialogBasic.tsx":Rr,"../../../packages/Dialog/_example/DialogContent.tsx":Mr,"../../../packages/Dialog/_example/DialogHeader.tsx":Lr,"../../../packages/Divider/_example/DividerBasic.tsx":Ir,"../../../packages/Divider/_example/DividerBorder.tsx":Or,"../../../packages/Divider/_example/DividerContent.tsx":Pr,"../../../packages/Divider/_example/DividerDirection.tsx":zr,"../../../packages/Drawer/_example/DrawerBasic.tsx":Fr,"../../../packages/Drawer/_example/DrawerContent.tsx":Hr,"../../../packages/Drawer/_example/DrawerHeader.tsx":Ur,"../../../packages/Drawer/_example/DrawerWIthHeader.tsx":Wr,"../../../packages/Icon/_example/IconBasic.tsx":jr,"../../../packages/Input/_example/InputBasic.tsx":Gr,"../../../packages/Input/_example/InputClearable.tsx":$r,"../../../packages/Input/_example/InputDisabled.tsx":Vr,"../../../packages/Input/_example/InputSize.tsx":Kr,"../../../packages/Layout/_example/LayoutBasic.tsx":Zr,"../../../packages/Layout/_example/LayoutBootstrap.tsx":Xr,"../../../packages/Layout/_example/LayoutGutter.tsx":qr,"../../../packages/Layout/_example/LayoutJustify.tsx":Yr,"../../../packages/Layout/_example/LayoutMix.tsx":Jr,"../../../packages/Layout/_example/LayoutOffset.tsx":Qr,"../../../packages/Link/_example/LinkBasic.tsx":et,"../../../packages/Link/_example/LinkDisabled.tsx":rt,"../../../packages/Link/_example/LinkIcon.tsx":tt,"../../../packages/Link/_example/LinkUnderline.tsx":nt,"../../../packages/Message/_example/MessageBasic.tsx":at,"../../../packages/Message/_example/MessageCenter.tsx":ot,"../../../packages/Message/_example/MessagePlain.tsx":it,"../../../packages/Message/_example/MessageShowClose.tsx":st,"../../../packages/Message/_example/MessageType.tsx":lt,"../../../packages/MessageBox/_example/MessageBoxBasic.tsx":ct,"../../../packages/MessageBox/_example/MessageBoxConfirm.tsx":pt,"../../../packages/MessageBox/_example/MessageBoxMessage.tsx":ut,"../../../packages/Notification/_example/NotificationBasic.tsx":dt,"../../../packages/Notification/_example/NotificationPosition.tsx":gt,"../../../packages/Notification/_example/NotificationShowClose.tsx":mt,"../../../packages/Notification/_example/NotificationType.tsx":ft,"../../../packages/Popconfirm/_example/PopconfirmBasic.tsx":ht,"../../../packages/Popconfirm/_example/PopconfirmEvent.tsx":_t,"../../../packages/Popconfirm/_example/PopconfirmIcon.tsx":xt,"../../../packages/Popover/_example/PopoverBasic.tsx":bt,"../../../packages/Progress/_example/ProgressBasic.tsx":Bt,"../../../packages/Progress/_example/ProgressTextInside.tsx":vt,"../../../packages/Rate/_example/RateBasic.tsx":yt,"../../../packages/Result/_example/ResultBasic.tsx":Ct,"../../../packages/Result/_example/ResultIcon.tsx":wt,"../../../packages/Scrollbar/_example/ScrollbarBasic.tsx":Tt,"../../../packages/Space/_example/SpaceAlignment.tsx":kt,"../../../packages/Space/_example/SpaceBasic.tsx":St,"../../../packages/Space/_example/SpaceDirection.tsx":Nt,"../../../packages/Space/_example/SpaceSize.tsx":Et,"../../../packages/Space/_example/SpaceSize2.tsx":At,"../../../packages/Space/_example/SpaceSpacer.tsx":Dt,"../../../packages/Space/_example/SpaceSpacer2.tsx":Rt,"../../../packages/Space/_example/SpaceWrap.tsx":Mt,"../../../packages/Switch/_example/SwitchActionIcon.tsx":Lt,"../../../packages/Switch/_example/SwitchBasic.tsx":It,"../../../packages/Switch/_example/SwitchBeforeChange.tsx":Ot,"../../../packages/Switch/_example/SwitchDisabled.tsx":Pt,"../../../packages/Switch/_example/SwitchIcon.tsx":zt,"../../../packages/Switch/_example/SwitchLoading.tsx":Ft,"../../../packages/Switch/_example/SwitchSize.tsx":Ht,"../../../packages/Switch/_example/SwitchText.tsx":Ut,"../../../packages/Table/_example/TableBasic.tsx":Wt,"../../../packages/Table/_example/TableBorder.tsx":jt,"../../../packages/Table/_example/TableStripe.tsx":Gt,"../../../packages/Tag/_example/TagBasic.tsx":$t,"../../../packages/Tag/_example/TagClosable.tsx":Vt,"../../../packages/Tag/_example/TagEffect.tsx":Kt,"../../../packages/Tag/_example/TagRound.tsx":Zt,"../../../packages/Tag/_example/TagSize.tsx":Xt,"../../../packages/Text/_example/TextBasic.tsx":qt,"../../../packages/Text/_example/TextSize.tsx":Yt,"../../../packages/Text/_example/TextTruncated.tsx":Jt,"../../../packages/Tooltip/_example/TooltipBasic.tsx":Qt,"../../../packages/Tooltip/_example/TooltipContent.tsx":en,"../../../packages/Tooltip/_example/TooltipDisabled.tsx":rn,"../../../packages/Tooltip/_example/TooltipEffect.tsx":tn});let _={display:f?"":"none"};oe.useEffect(()=>{s.current&&(Object.keys(p).forEach(S=>{S.indexOf(r)!==-1&&a(p[S])}),setTimeout(()=>{ve.highlightElement(s.current)},0))},[r]);function b(){h(!f)}return k.jsx(k.Fragment,{children:k.jsxs("div",{className:"code-block",children:[k.jsx("div",{className:"code-block-component",children:n}),k.jsx("div",{className:"op-btns",children:k.jsx("button",{onClick:b,className:"reset-btn el-icon op-btn el-tooltip__trigger el-tooltip__trigger",children:k.jsx("i",{className:"el-icon",style:{fontSize:"16px"},children:k.jsx("svg",{preserveAspectRatio:"xMidYMid meet",viewBox:"0 0 24 24",width:"1.2em",height:"1.2em","data-v-5d9e4641":"",children:k.jsx("path",{fill:"currentColor",d:"m23 12l-7.071 7.071l-1.414-1.414L20.172 12l-5.657-5.657l1.414-1.414L23 12zM3.828 12l5.657 5.657l-1.414 1.414L1 12l7.071-7.071l1.414 1.414L3.828 12z"})})})})}),k.jsx("div",{className:"code-block-wrapper",style:_,children:k.jsx("div",{className:"code-block-pre language-react",children:k.jsx("pre",{children:k.jsx("code",{id:e,ref:s,className:e,children:i})})})})]})})}export{aa as C};
