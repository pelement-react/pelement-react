            ...
            <div className="el-card__header">
              <div className="changelog-header">
                <div className="changelog-meta">
                  ...
                  <p className="changelog-date">{version.date}</p>
                </div>
