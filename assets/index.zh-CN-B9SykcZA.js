import{j as e}from"./index-BsBAGMli.js";import{C as a}from"./CodeBlock-CpRXl1An.js";import{B as i,N as r}from"./index-Bl9mz1VL.js";function l(){let n=0;function s(){n++,r.success(`This is a message.${n}`)}function o(){n++,r.success(e.jsxs(e.Fragment,{children:["This is a ",e.jsx("span",{style:{color:"teal"},children:"message"}),".",n]}))}return e.jsxs(e.Fragment,{children:[e.jsx(i,{plain:!0,onClick:s,children:"Show message"}),e.jsx(i,{plain:!0,onClick:o,children:"ReactNode"})]})}function p(){const n=()=>{r.info("This is a message.")},s=()=>{r.success("Congrats, this is a success message.")},o=()=>{r.warning("Warning, this is a warning message.")},t=()=>{r.error("Oops, this is a error message.")};return e.jsxs(e.Fragment,{children:[e.jsx(i,{plain:!0,onClick:s,children:"Success"}),e.jsx(i,{plain:!0,onClick:o,children:"Warning"}),e.jsx(i,{plain:!0,onClick:n,children:"Message"}),e.jsx(i,{plain:!0,onClick:t,children:"Error"})]})}function h(){const n=()=>{r.open({message:"This is a message.",type:"info",plain:!0})},s=()=>{r.open({message:"Congrats, this is a success message.",type:"success",plain:!0})},o=()=>{r.open({message:"Warning, this is a warning message.",type:"warning",plain:!0})},t=()=>{r.open({message:"Oops, this is a error message.",type:"error",plain:!0})};return e.jsxs(e.Fragment,{children:[e.jsx(i,{plain:!0,onClick:s,children:"Success"}),e.jsx(i,{plain:!0,onClick:o,children:"Warning"}),e.jsx(i,{plain:!0,onClick:n,children:"Message"}),e.jsx(i,{plain:!0,onClick:t,children:"Error"})]})}function g(){const n=()=>{r.open({message:"This is a message.",type:"info",showClose:!0})},s=()=>{r.open({message:"Congrats, this is a success message.",type:"success",showClose:!0})},o=()=>{r.open({message:"Warning, this is a warning message.",type:"warning",showClose:!0})},t=()=>{r.open({message:"Oops, this is a error message.",type:"error",showClose:!0})};return e.jsxs(e.Fragment,{children:[e.jsx(i,{plain:!0,onClick:s,children:"Success"}),e.jsx(i,{plain:!0,onClick:o,children:"Warning"}),e.jsx(i,{plain:!0,onClick:n,children:"Message"}),e.jsx(i,{plain:!0,onClick:t,children:"Error"})]})}function u(){const n=()=>{r.open({message:"Centered text",type:"info",center:!0})};return e.jsx(e.Fragment,{children:e.jsx(i,{plain:!0,onClick:n,children:"Centered text"})})}function c(n){const s={h1:"h1",h2:"h2",p:"p",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{children:"Message 消息提示"}),`
`,`
...
`,e.jsx(a,{name:"MessageBasic",children:e.jsx(l,{})}),`
...
`,e.jsx(a,{name:"MessageType",children:e.jsx(p,{})}),`
`,e.jsx(s.h2,{children:"Plain"}),`
`,e.jsx(s.p,{children:"设置 plain 为 plain 背景。"}),`
`,e.jsx(a,{name:"MessagePlain",children:e.jsx(h,{})}),`
...
`,e.jsx(a,{name:"MessageShowClose",children:e.jsx(g,{})}),`
`,e.jsx(s.h2,{children:"文字居中"}),`
`,e.jsx(s.p,{children:"使用 center 属性让文字水平居中。"}),`
`,e.jsx(a,{name:"MessageCenter",children:e.jsx(u,{})})]})}function m(n={}){const{wrapper:s}=n.components||{};return s?e.jsx(s,{...n,children:e.jsx(c,{...n})}):c(n)}export{m as default};
