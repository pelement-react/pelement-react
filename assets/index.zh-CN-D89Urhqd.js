import{j as n,B as i,ai as o}from"./index-BnsErXRG.js";import{C as s}from"./CodeBlock-ByD7R5yk.js";function a(){function t(){o.open({title:"Title",message:n.jsx("i",{style:{color:"teal"},children:"This is a reminder"})})}function e(){o.open({title:"Prompt",message:"This is a message that does not automatically close",duration:0})}return n.jsxs(n.Fragment,{children:[n.jsx(i,{plain:!0,onClick:t,children:"Closes automatically"}),n.jsx(i,{plain:!0,onClick:e,children:"Won't close automatically"})]})}function p(){function t(){o.open({title:"Success",message:"This is a success message",type:"success"})}function e(){o.open({title:"Warning",message:"This is a warning message",type:"warning"})}function r(){o.open({title:"Info",message:"This is an info message",type:"info"})}function c(){o.open({title:"Error",message:"This is an error message",type:"error"})}return n.jsxs(n.Fragment,{children:[n.jsx(i,{plain:!0,onClick:t,children:"Success"}),n.jsx(i,{plain:!0,onClick:e,children:"Warning"}),n.jsx(i,{plain:!0,onClick:r,children:"Info"}),n.jsx(i,{plain:!0,onClick:c,children:"Error"})]})}function h(){function t(){o.open({title:"Custom Position",message:"I'm at the top right corner"})}function e(){o.open({title:"Custom Position",message:"I'm at the bottom right corner",position:"bottom-right"})}function r(){o.open({title:"Custom Position",message:"I'm at the bottom left corner",position:"bottom-left"})}function c(){o.open({title:"Custom Position",message:"I'm at the top left corner",position:"top-left"})}return n.jsxs(n.Fragment,{children:[n.jsx(i,{plain:!0,onClick:t,children:"Top Right"}),n.jsx(i,{plain:!0,onClick:e,children:"Bottom Right"}),n.jsx(i,{plain:!0,onClick:r,children:"Bottom Left"}),n.jsx(i,{plain:!0,onClick:c,children:"Top Left"})]})}function m(){function t(){o.open({title:"Info",message:"This is a message without close button",showClose:!1})}return n.jsx(n.Fragment,{children:n.jsx(i,{plain:!0,onClick:t,children:"Hide close button"})})}function l(t){const e={h1:"h1",h2:"h2",p:"p",...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{children:"Notification 通知"}),`
`,`
...
`,n.jsx(s,{name:"NotificationShowClose",children:n.jsx(m,{})})]})}function d(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(l,{...t})}):l(t)}export{d as default};
